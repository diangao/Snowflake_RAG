...
def main():
    ...
    st.title("Animal Health Helper :cat: :dog:")
    st.write(
        """Welcome! This application helps pet owners decide whether their pet's condition
        requires immediate vet attention or can be handled at home.
        """
    )    
